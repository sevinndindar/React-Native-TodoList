...
const styles=StyleSheet.create({
    inputContainer:{flexDirection:"row" , backgroundColor:"#AAAAAA"},
    input:{flex:5 , height:50, backgroundColor:"white",fontSize:20, padding:10, margin:10, borderRadius:15},
    button:{flex:1 , height:50, margin:10,alignItems:"center", justifyContent:"center", backgroundColor:"#0074D9", borderRadius:15},
